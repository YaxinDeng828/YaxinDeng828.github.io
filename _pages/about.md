...
<main class="home-shell">
  <div class="home-layout">
    <aside class="home-sidebar{% unless site.show_profile_photo %} home-sidebar--no-photo{% endunless %}" aria-labelledby="sidebar-name">
      {% if site.show_profile_photo %}
      ...
      <section id="papers" class="home-section" aria-labelledby="papers-title">
        ...
        <article class="paper-entry" tabindex="0" aria-describedby="memdtg-summary">
          ...
          <p class="paper-authors">
            ...
            <span class="language-text language-text--zh" lang="zh-CN"><strong>邓雅馨</strong>、秦宏超、高天翊、曾广、李荣华</span>
          </p>
          <p class="paper-meta">
